  ...
  const categories = [
    {
      ...
      description: 'In-depth analysis for technical decision-makers. Bridge security, L2 models, and advanced vulnerability patterns.',
      articles: [
        { title: 'Bridge Hack Analysis: Patterns and Prevention', slug: 'bridge-hack-analysis', difficulty: 'Hard' },
        { title: 'L2 Security Model: Sequencer, Provers, and Data Availability', slug: 'l2-security-model', difficulty: 'Hard' },
        { title: 'Reentrancy Edge Cases: Beyond the Classic Pattern', slug: 'reentrancy-edge-cases', difficulty: 'Hard' },
      ],
    },
    {
      id: 'vulnerabilities',
    ...
    <div className={styles.knowledgeBasePage}>
      ...
      <section className={styles.header}>
        <div className="container">
          <h1>Research</h1>
          <p>Technical insights on smart contract security and best practices</p>
        </div>
      </section>
            ...
            <div key={category.id} className={styles.categorySection}>
              ...
              <div className={styles.articlesGrid}>
                {category.articles.map((article) => (
                  <Link
                    key={article.slug}
                    href={`/research/${category.id}/${article.slug}`}
